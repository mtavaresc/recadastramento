...
(function (Fa, T, k) {
    var S = function (g) {
        ...
        function S(a) {
            ...
            !a.sEmptyTable && (c && "Consulta não retornou dados" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sEmptyTable: "Consulta não retornou dados",
                sInfo: "Mostrando _START_ até _END_ de _TOTAL_ registros",
                sInfoEmpty: "Mostrando 0 até 0 de 0 registros",
                sInfoFiltered: "(filtrado de _MAX_ no total de registros)",
                sInfoPostFix: "",
                sDecimal: ",",
                sThousands: ".",
